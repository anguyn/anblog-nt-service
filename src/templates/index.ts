...
function verifyEmailTemplate(data: { name: string; verificationUrl: string; locale: string }) {
...
function passwordResetTemplate(data: { name: string; resetUrl: string; locale: string }) {
  const isVietnamese = data.locale === 'vi';
...
function welcomeTemplate(data: { name: string; locale: string }) {
  const isVietnamese = data.locale === 'vi';
